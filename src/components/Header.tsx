...
export const Header: React.FC = () => {
  return (
    <section>
      <div className="relative flex flex-col items-center justify-center h-screen px-8 py-12 mx-auto snap-start max-w-7xl lg:px-16 md:px-12 lg:py-24">
        <nav className="absolute flex items-end justify-end w-full top-6 ">
          <ThemeToggle />
        </nav>

        <div className="flex flex-col items-center justify-center w-full text-center lg:p-10">
          <div className="justify-center w-full mx-auto">
            <p className="mt-8 text-5xl tracking-tight text-black dark:text-white">
              Hello I am Umut,
            </p>
            <p className="max-w-xl mx-auto mt-4 text-lg tracking-tight text-gray-600 dark:text-gray-400">
